...
from center.views import HomeTemplateView, OnAuctionListView, AuctionTableCreateView, AuctionTableUpdateView, \
    ...
    PofileDetailView, \
    AcceptDealDetailView, AddPicCreateView, BettersDeleteView, FollowersCreateView, FollowersListView
...
urlpatterns = [
    ...
    path('<int:pk>/follower/new/', FollowersCreateView.as_view(), name='create_follower'),
    path('<int:pk>/follower/view/', FollowersListView.as_view(), name='followers_list'),
